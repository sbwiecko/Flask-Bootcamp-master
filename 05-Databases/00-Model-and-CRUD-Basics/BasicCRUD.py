...
# Note lots of ORM filter options here, e.g.,
# filter(), filter_by(), limit(), order_by(), group_by()
# Also lots of executor options, e.g.,
...
# Filters
puppy_sam = Puppy.query.filter_by(name='Sammy').all() # Returns list
# could also use filter_by().first()
print(puppy_sam)
print('\n')
